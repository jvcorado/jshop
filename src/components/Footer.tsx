    ...
    <footer className="bg-gray-900">
      <div className=" container mx-auto px-4 py-12 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">JShop</h3>
            <p className="text-gray-400">
              Sua loja online de produtos de alta qualidade com os melhores
              preços e entrega rápida.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="min-w-0 flex-1 rounded-l-md border-0 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-indigo-600"
              />
              <button
                type="submit"
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 flex justify-between">
          <p className="text-gray-400 text-sm">
            &copy; 2025 JShop. Todos os direitos reservados.
          </p>
